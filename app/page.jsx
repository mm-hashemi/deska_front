...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-zinc-100 font-sans">
      {/* Header */}
      <header className="container mx-auto bg-zinc-100 px-6 py-4 flex items-center justify-between">
        {/* Logo+Brand */}
      ...
      <section className="w-full bg-[#21A1F3] min-h-[550px] flex flex-col justify-start items-center relative">
        ...
        {/* Semi-circle bg */}
        <div className="absolute left-1/2 -translate-x-1/2 top-[380px] w-[310px] h-[310px] bg-zinc-100 rounded-t-full "></div>
      ...
      <div className=" bg-zinc-100  w-full mt-44">
        <DashboardNav/>
        <CardProfile/>
        <Articles/>
        <AwardsAndFeatures/>
      ...
      {/* Footer */}
      <footer className="w-full bg-[#313131] min-h-[160px] flex flex-col md:flex-row items-center md:items-start px-7 py-8 gap-10 text-white">
        {/* Left */}
